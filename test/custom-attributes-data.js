    ...
    // Test custom attributes in outgoing messages by checking what client sends
    {
        trigger: {
            ...
            condition: (msg) => {
                ...
                return (
                    options._tracking_id === "sub_12345" &&
...

    {
        trigger: {
            ...
            condition: (msg) => {
                ...
                return (
                    options._tracking_id === "pub_67890" &&
...

    {
        trigger: {
            ...
            condition: (msg) => {
                ...
                return (
                    options._request_id === "call_abcdef" &&
...

    {
        trigger: {
            ...
            condition: (msg) => {
                ...
                return (
                    options._cancel_reason === "user_requested" &&
...

    {
        trigger: {
            ...
            condition: (msg) => {
                ...
                return (
                    options._handler_version === "2.1.0" &&
        ...
        trigger: {
            ...
            condition: (msg) => {
                ...
                return (
                    ...
                    !options.no_underscore
                ); // No underscore - should be filtered
            },
        },
        response: [
            WAMP_MSG_SPEC.RESULT,
