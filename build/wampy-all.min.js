...
// One byte of UTF-8
if(128>f)a.setUint8(b++,f>>>0&127|0);else
// Two bytes of UTF-8
if(2048>f)a.setUint8(b++,f>>>6&31|192),a.setUint8(b++,f>>>0&63|128);else
// Three bytes of UTF-8.
if(65536>f)a.setUint8(b++,f>>>12&15|224),a.setUint8(b++,f>>>6&63|128),a.setUint8(b++,f>>>0&63|128);else{
// Four bytes of UTF-8
if(!(1114112>f))throw new Error("bad codepoint "+f);a.setUint8(b++,f>>>18&7|240),a.setUint8(b++,f>>>12&63|128),a.setUint8(b++,f>>>6&63|128),a.setUint8(b++,f>>>0&63|128)}}}function c(a,b,c){for(var d="",e=b,f=b+c;f>e;e++){var g=a.getUint8(e);
// One byte character
if(0!==(128&g))
// Two byte character
if(192!==(224&g))
...
if(224!==(240&g)){
// Four byte character
if(240!==(248&g))throw new Error("Invalid byte "+g.toString(16));d+=String.fromCharCode((7&g)<<18|(63&a.getUint8(++e))<<12|(63&a.getUint8(++e))<<6|(63&a.getUint8(++e))<<0)}else d+=String.fromCharCode((15&g)<<12|(63&a.getUint8(++e))<<6|(63&a.getUint8(++e))<<0);else d+=String.fromCharCode((15&g)<<6|63&a.getUint8(++e));else d+=String.fromCharCode(g)}return d}function d(a){for(var b=0,c=0,d=a.length;d>c;c++){var e=a.charCodeAt(c);if(128>e)b+=1;else if(2048>e)b+=2;else if(65536>e)b+=3;else{if(!(1114112>e))throw new Error("bad codepoint "+e);b+=4}}return b}
// http://wiki.msgpack.org/display/MSGPACK/Format+specification
function e(a,b){this.offset=b||0,this.view=a}function f(a){var b=new jDataView(a),c=new e(b),d=c.parse();if(c.offset!==a.byteLength)throw new Error(a.byteLength-c.offset+" trailing bytes");return d}function g(a,c,e){var f,h,i,j,k=typeof a;
// Strings Bytes
if("string"===k){
// fix str
if(f=d(a),32>f)return c.setUint8(e,160|f),b(c,e+1,a),1+f;
// str 8
if(256>f)return c.setUint8(e,217),c.setUint16(e+1,f),b(c,e+2,a),2+f;
// str 16
if(65536>f)return c.setUint8(e,218),c.setUint16(e+1,f),b(c,e+3,a),3+f;
// str 32
if(4294967296>f)return c.setUint8(e,219),c.setUint32(e+1,f),b(c,e+5,a),5+f}if(a instanceof ArrayBuffer){
// buffer 8
if(f=a.byteLength,256>f)return c.setUint8(e,196),c.setUint16(e+1,f),new Uint8Array(c.buffer).set(new Uint8Array(a),e+2),2+f;
// buffer 16
if(65536>f)return c.setUint8(e,216),c.setUint16(e+1,f),new Uint8Array(c.buffer).set(new Uint8Array(a),e+3),3+f;
// buffer 32
if(4294967296>f)return c.setUint8(e,217),c.setUint32(e+1,f),new Uint8Array(c.buffer).set(new Uint8Array(a),e+5),5+f}if("number"===k){
// Floating Point
if(a%1!==0)return c.setUint8(e,203),c.setFloat64(e+1,a),9;
// Integers
if(a>=0){
// positive fixnum
if(128>a)return c.setUint8(e,a),1;
// uint 8
if(256>a)return c.setUint8(e,204),c.setUint8(e+1,a),2;
// uint 16
if(65536>a)return c.setUint8(e,205),c.setUint16(e+1,a),3;
// uint 32
if(4294967296>a)return c.setUint8(e,206),c.setUint32(e+1,a),5;
// uint 64
if(0x10000000000000000>a)return c.setUint8(e,207),c.setUint64(e+1,a),9;throw new Error("Number too big 0x"+a.toString(16))}
// negative fixnum
if(a>=-32)return c.setInt8(e,a),1;
// int 8
if(a>=-128)return c.setUint8(e,208),c.setInt8(e+1,a),2;
// int 16
if(a>=-32768)return c.setUint8(e,209),c.setInt16(e+1,a),3;
// int 32
if(a>=-2147483648)return c.setUint8(e,210),c.setInt32(e+1,a),5;
// int 64
if(a>=-2147483648)return c.setUint8(e,211),c.setUint64(e+1,a),9;throw new Error("Number too small -0x"+(-a).toString(16).substr(1))}
// undefined
if("undefined"===k)return c.setUint8(e,212),c.setUint8(e+1,0),c.setUint8(e+2,0),1;
// null
if(null===a)return c.setUint8(e,192),1;
// Boolean
if("boolean"===k)return c.setUint8(e,a?195:194),1;if("function"==typeof a.toJSON)return g(a.toJSON(),c,e);
// Container Types
if("object"===k){if(h=0,i=Array.isArray(a))f=a.length;else{var l=Object.keys(a);f=l.length}if(
// fixarray
...
// Raw Bytes
if("string"===g){if(b=d(a),32>b)return 1+b;if(256>b)return 2+b;if(65536>b)return 3+b;if(4294967296>b)return 5+b}if(a instanceof ArrayBuffer){if(b=a.byteLength,256>b)return 2+b;if(65536>b)return 3+b;if(4294967296>b)return 5+b}if("number"===g){
// Floating Point
// double
if(a<<0!==a)return 9;
// Integers
...
// uint 64
if(0x10000000000000000>a)return 9;throw new Error("Number too big 0x"+a.toString(16))}
// negative fixnum
if(a>=-32)return 1;
// int 8
if(a>=-128)return 2;
...
if(a>=-32768)return 3;
// int 32
if(a>=-2147483648)return 5;
// int 64
if(a>=-0x8000000000000000)return 9;throw new Error("Number too small -0x"+a.toString(16).substr(1))}
// Boolean, null, undefined
if("boolean"===g||null===a)return 1;if("undefined"===g)return 3;if("function"==typeof a.toJSON)return h(a.toJSON());
// Container Types
if("object"===g){if("function"==typeof a.toJSON&&(a=a.toJSON()),c=0,Array.isArray(a))for(b=a.length,f=0;b>f;f++)c+=h(a[f]);else for(e=Object.keys(a),b=e.length,f=0;b>f;f++)c+=h(e[f])+h(a[e[f]]);if(16>b)return 1+c;if(65536>b)return 3+c;if(4294967296>b)return 5+c;throw new Error("Array or object too long 0x"+b.toString(16))}if("function"===g)return 0;throw new Error("Unknown type "+g)}var i={};
// Encode string as utf8 into dataview at offset
return i.inspect=a,i.utf8Write=b,i.utf8Read=c,i.utf8ByteCount=d,i.encode=function(a){var b=new ArrayBuffer(h(a)),c=new jDataView(b);return g(a,c,0),b},i.decode=f,e.prototype.map=function(a){for(var b={},c=0;a>c;c++){var d=this.parse();b[d]=this.parse()}return b},e.prototype.buf=function(a){var b=new ArrayBuffer(a);return new Uint8Array(b).set(new Uint8Array(this.view.buffer,this.offset,a),0),this.offset+=a,b},e.prototype.u8str=function(a){var b=c(this.view,this.offset,a);return this.offset+=a,b},e.prototype.array=function(a){for(var b=new Array(a),c=0;a>c;c++)b[c]=this.parse();return b},e.prototype.parse=function(){var a,b,c,d=this.view.getUint8(this.offset);
// Positive FixNum
if(0===(128&d))return this.offset++,d;
// FixMap
if(128===(240&d))return b=15&d,this.offset++,this.map(b);
// FixArray
if(144===(240&d))return b=15&d,this.offset++,this.array(b);
// FixStr
if(160===(224&d))return b=31&d,this.offset++,this.u8str(b);
// Negative Fixnum
if(224===(224&d))return a=this.view.getInt8(this.offset),this.offset++,a;switch(d){
// nil
...
// bin 8
case 196:return b=this.view.getUint8(this.offset+1),this.offset+=2,this.buf(b);
// bin 16
case 197:return b=this.view.getUint16(this.offset+1),this.offset+=3,this.buf(b);
// bin 32
case 198:return b=this.view.getUint32(this.offset+1),this.offset+=5,this.buf(b);
// ext 8
case 199:return b=this.view.getUint8(this.offset+1),c=this.view.getUint8(this.offset+2),this.offset+=3,[c,this.buf(b)];
// ext 16
case 200:return b=this.view.getUint16(this.offset+1),c=this.view.getUint8(this.offset+3),this.offset+=4,[c,this.buf(b)];
// ext 32
case 201:return b=this.view.getUint32(this.offset+1),c=this.view.getUint8(this.offset+5),this.offset+=6,[c,this.buf(b)];
// float
case 202:return a=this.view.getFloat32(this.offset+1),this.offset+=5,a;
// double
case 203:return a=this.view.getFloat64(this.offset+1),this.offset+=9,a;
// uint8
case 204:return a=this.view.getUint8(this.offset+1),this.offset+=2,a;
// uint 16
case 205:return a=this.view.getUint16(this.offset+1),this.offset+=3,a;
// uint 32
case 206:return a=this.view.getUint32(this.offset+1),this.offset+=5,a;
// uint 64
case 207:return a=this.view.getUint64(this.offset+1),this.offset+=9,parseInt(a);
// int 8
case 208:return a=this.view.getInt8(this.offset+1),this.offset+=2,a;
// int 16
case 209:return a=this.view.getInt16(this.offset+1),this.offset+=3,a;
// int 32
case 210:return a=this.view.getInt32(this.offset+1),this.offset+=5,a;
// int 64
case 211:return a=this.view.getInt64(this.offset+1),this.offset+=9,parseInt(a);
// fixext 1
case 212:return c=this.view.getUint8(this.offset+1),a=this.view.getUint8(this.offset+2),this.offset+=3,0===c&&0===a?void 0:[c,a];
// fixext 2
case 213:return c=this.view.getUint8(this.offset+1),this.offset+=2,[c,this.buf(2)];
// fixext 4
case 214:return c=this.view.getUint8(this.offset+1),this.offset+=2,[c,this.buf(4)];
// fixext 8
case 215:return c=this.view.getUint8(this.offset+1),this.offset+=2,[c,this.buf(8)];
// fixext 16
case 216:return c=this.view.getUint8(this.offset+1),this.offset+=2,[c,this.buf(16)];
// str 8
case 217:return b=this.view.getUint8(this.offset+1),this.offset+=2,this.u8str(b);
// str 16
case 218:return b=this.view.getUint16(this.offset+1),this.offset+=3,this.u8str(b);
// str 32
case 219:return b=this.view.getUint32(this.offset+1),this.offset+=5,this.u8str(b);
// array 16
case 220:return b=this.view.getUint16(this.offset+1),this.offset+=3,this.array(b);
// array 32
case 221:return b=this.view.getUint32(this.offset+1),this.offset+=5,this.array(b);
// map 16
case 222:return b=this.view.getUint16(this.offset+1),this.offset+=3,this.map(b);
// map 32
case 223:return b=this.view.getUint32(this.offset+1),this.offset+=5,this.map(b)}throw new Error("Unknown type 0x"+d.toString(16))},i});
...
this._cache.sessionId=b[1],this._cache.server_wamp_features=b[2],
// Firing onConnect event on real connection to WAMP server
this._options.onConnect&&this._options.onConnect(),this._cache.reconnectingAttempts&&(
...
this._requests[b[1]]?(this._requests[b[1]].callbacks.onSuccess&&this._requests[b[1]].callbacks.onSuccess(),delete this._requests[b[1]]):this._cache.opStatus=e.NON_EXIST_PUBLISH_PUBLISHED;break;case d.EVENT:if(this._subscriptions[b[1]]){switch(b.length){case 4:
...
this._requests[b[1]]?(this._rpcRegs[this._requests[b[1]].topic]=this._rpcRegs[b[2]]={id:b[2],callbacks:[this._requests[b[1]].callbacks.rpc]},this._rpcNames.push(this._requests[b[1]].topic),this._requests[b[1]].callbacks.onSuccess&&this._requests[b[1]].callbacks.onSuccess(),delete this._requests[b[1]]):this._cache.opStatus=e.NON_EXIST_RPC_REG;break;case d.UNREGISTER:
// WAMP SPEC:
